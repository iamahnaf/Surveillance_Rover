...
void moveCar(int inputValue)
{
  ...
  switch(inputValue)
  {
    ...
    case UP:
       rotateMotor(RIGHT_MOTOR, BACKWARD);  // Was FORWARD
       rotateMotor(LEFT_MOTOR, BACKWARD);   // Was FORWARD
       break;

    case DOWN:
      rotateMotor(RIGHT_MOTOR, FORWARD);   // Was BACKWARD
      rotateMotor(LEFT_MOTOR, FORWARD);    // Was BACKWARD
      break;
